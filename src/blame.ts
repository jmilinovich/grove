...
// error. Default OFF — flip to "true" if you want a hard guarantee that
// every caller is provenance-aware.
//
...
// affected by this flag. Their commits surface as legacy-unknown at read
// time, which the blame walker treats as transparent.
